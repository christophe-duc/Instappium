...
class xpath:
    ...
    __xpath["search"] = {
        ...
        "accounts_results": "//android.widget.TextView[@resource-id='com.instagram.android:id/tab_button_name_text' and @text='ACCOUNTS']",
        "hashtags_results": "//android.widget.TextView[@resource-id='com.instagram.android:id/tab_button_name_text' and @text='TAGS']",
        "places_results": "//android.widget.TextView[@resource-id='com.instagram.android:id/tab_button_name_text' and @text='PLACES']",
